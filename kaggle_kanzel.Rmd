...
subtitle: "Using Kanzel Daily  ISN/R"
...
kanzel<-kanzel[,.(Ymd,Year,Month,g_n,s_n,g_s,s_s,R,R_n,R_s,Spots,Groups,Cts,Yes)]
...
ggplot(aes(x=Year,y=Days,fill=Yes)) + geom_bar(position="stack",stat="identity")
```
...
```{r cycle25, echo=FALSE}
ggplot(data=df) +geom_bar(aes(x=Cts,fill=clarity))
```
